...
{
    ERROR(-1), ERROR_MESSAGE(-2), INPUT_CHAR(2), OUTPUT_CHAR(3), SERVER_STATUS(5), PROGRAM_TRANSFER_START(10), PROGRAM_TRANSFER_END(11), PROGRAM_START(12), CONNECTION_TERMINATION(100), UTF(200);
